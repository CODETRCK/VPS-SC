...
# Note per _program_, not per process. So for example this CODETRCK
# will report RAM used by all httpd process together. In detail it reports:
# sum(private RAM for program processes) + sum(Shared RAM for program processes)
# The shared RAM is problematic to calculate, and this CODETRCK automatically
# selects the most accurate method available for your kernel.

# Licence: LGPLv2
# Author:  P@draigBrady.com
# Source:  http://www.pixelbeat.org/CODETRCKs/ps_mem.py
...
# V3.8      17 Jun 2016
#   http://github.com/pixelb/CODETRCKs/commits/master/CODETRCKs/ps_mem.py
...
def getCmdName(pid, split_args, discriminate_by_pid):
    ...
    try:
        ...
        # https://github.com/pixelb/CODETRCKs/pull/10, so take string up to NUL
        path = path.split('\0')[0]
    except OSError:
        val = sys.exc_info()[1]
...
def main():
    ...
    # one which is reenabled after this CODETRCK finishes.
    sys.stdout.close()
