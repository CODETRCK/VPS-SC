...
vless_direct="vless://${uuid}@${domain}:${vless1}?security=xtls&encryption=none&headerType=none&type=tcp&flow=xtls-rprx-direct&sni=CODETRCK#$user"
vless_splice="vless://${uuid}@${domain}:${vless1}?security=xtls&encryption=none&headerType=none&type=tcp&flow=xtls-rprx-splice&sni=CODETRCK#$user"
...
echo -e "================================="
echo -e "Gantikan CODETRCK dengan BUG anda"
echo -e "================================="
